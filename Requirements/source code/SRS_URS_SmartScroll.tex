...
\umlusecase[name=case2, width=2cm, y=-5.5] {Track Progress} 
\umlusecase[name=case3, width=1.5cm, y=-3.75] {Content Sharing} 
\umlusecase[name=case4, width=2cm, x=5, y=-1] {Generate Flashcards} 
\umlusecase[name=case5, width=2.5cm, x=5, y=-3] {Generate Summaries} 
\umlusecase[name=case6, width=2.5cm, x=5, y=-5] {Generate a Quiz} 
\umlusecase[name=case7, width=2.5cm, x=0, y=-7] {Set Learning Preferences} 
\umlusecase[name=case8, width=2cm, x=0, y=-2] {Edit Account Details} 
\end{umlsystem}
% end Use-Case-System 
%Actors
\umlactor[x=-3.5, y=-3]{user}
\umlactor[x=10, y=-3]{AI-Powered Module}
%Relations
\umlassoc{user}{case1}
\umlassoc{user}{case2}
\umlassoc{user}{case3}
\umlassoc{user}{case7}
\umlassoc{user}{case8}
\umlassoc{AI-Powered Module}{case4}
\umlassoc{AI-Powered Module}{case5}
\umlassoc{AI-Powered Module}{case6}
\end{tikzpicture}
\end{figure}
